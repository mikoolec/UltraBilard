...
static std::vector<Upgrade> PelnaBazaUlepszen = {
    ...
    // Bile (rodzaj 1)
    {201,"Kowadlo", "+10% masy bili", 50, 1},
    {202,"Balon", "-10% masy bili", 150, 1},
    {203,"Kamien", "Biala bila zatrzymuje sie po zderzeniu", 50, 1},
    {204,"Bomba", "Przy pierwszym uderzeniu w bile, odpycha pobliskie bile", 150, 1},
    {205,"Sprezyna", "+10% odbicia od bandy", 30, 1},
    {206,"Kostka Lodu", "Zerowe tarcie bili", 50, 1},
    {207,"Klej", "Natychmiastowe zatrzymanie zaraz po uderzeniu bili", 50, 1},
    {208,"Magnes", "+10% przyciagania do dziury", 150, 1},
    {209,"Duch", "Przenika przez inne bile", 100, 1},
    {210,"Ogien", "+5 punktow za zderzenie z inna bila", 100, 1},
    {211,"Diament", "+5 punktow za kazde odbicie od bandy", 50, 1},
